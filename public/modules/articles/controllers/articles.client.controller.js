...
angular.module('articles').controller('ArticlesController',
    ['$scope', '$stateParams', '$location', 'Authentication', 'Articles','Categories','BlogAnalyzer','$interval',
	function($scope, $stateParams, $location, Authentication, Articles, Categories, BlogAnalyzer,$interval) {
