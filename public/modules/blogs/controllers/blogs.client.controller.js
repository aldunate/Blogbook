...
// Blogs controller
angular.module('blogs').controller('BlogsController', ['$scope', '$stateParams', '$location', 'Authentication', 'Blogs','Articles',
	function($scope, $stateParams, $location, Authentication, Blogs, Articles) {
